...
export const ToolsCat = {
    languages: [Tools.TypeScript, Tools.JavaScript, Tools.HTML, Tools.CSS, Tools.SASS, Tools.PHP],
    frameworks: [Tools.React, Tools.NextJS, Tools.Node, Tools.Flutter],
    libraries: [Tools.ReactRouter, Tools.PreactSignals, Tools.PrimeReactUI, Tools.Tailwind],
    databases: [Tools.Firebase, Tools.MySQL],
    tools: [Tools.Git, Tools.Wordpress],
    software: [Tools.Illustrator],
