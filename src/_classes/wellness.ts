...
let socialWellness = new WellnessCategory("Social Wellness", faHeartPulse, [ProjectE.HobbyBuddy], green, WellnessE.Social, "the quality of relationships and social interactions in one's life")
let environmentalWellness = new WellnessCategory("Environmental Wellness", faSeedling, [ProjectE.ComfortCorner], purple, WellnessE.Environmental, "the well-being of their surroundings and the impact on personal health")
