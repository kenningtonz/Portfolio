...
export default function MindfulPage() {
    // let p = new ProjectInfo( description: "", tools: [Tools.PHP, Tools.Wordpress], objective: "", purpose: "", approach: "", link: "https://mindfulink.kennedyadams.ca", image: "", slug: "mindfulInk", project: ProjectE.MindfulInk, github: ")
    let project = {
        name: "Mindful Ink",
        tools: [Tools.PHP, Tools.Wordpress],
        description: "",
        github: "",
        link: "https://mindfulink.kennedyadams.ca",
        image: "../images/mindfulink.png",
        objective: "Create a Wordpress eCommerce site with a custom theme.",
        purpose: "",
        approach: "",
        project: ProjectE.MindfulInk
    }
