...
export default function Loading() {
    return (
        <motion.svg
            ...
            viewBox="0 0 100 100"
        >
            <motion.path variants={draw} custom={1} d="M49.99,38.454l.01-30c2.8,0,5.54.29,8.18.84l4.49-7.79c.83-1.44,2.67-1.93,4.1-1.1l16.46,9.5c1.43.83,1.92,2.66,1.1,4.1l-4.51,7.8c1.82,2.04,3.44,4.26,4.82,6.64l.01.03-25.98,15c0-.01-.01-.02-.02-.03-1.73-2.98-4.96-4.99-8.65-4.99h-.01Z" fill="none" stroke="#ffdc5e" stroke-miterlimit="10" stroke-width="2" />
